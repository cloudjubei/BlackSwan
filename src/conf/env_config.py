...
env_trade_all_tpsl_trailingTEST = EnvConfig(type= env_trade_all_tpsl.type, observations_contain= env_trade_all_tpsl.observations_contain, take_profit= 0.02, stop_loss=0.02, no_sell_action= env_trade_all_tpsl.no_sell_action, trailing_take_profit= 0.01)
