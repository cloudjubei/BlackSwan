    ...
    def create_mlp_custom(
        ...
        for module_idx in range(len(custom_net_arch)):
            ...
            if module_name == "activation_fn":
                ...
                modules.append(weight_norm(nn.Linear(net_sizes[idx], net_sizes[idx + 1], bias=True)))
                idx += 1 
            elif module_name == "spectral_norm":
                modules.append(spectral_norm(nn.Linear(net_sizes[idx], net_sizes[idx + 1], bias=True)))
                idx += 1 
                ...
                modules.append(ResidualBlock(net_sizes[idx]))
